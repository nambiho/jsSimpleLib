;(function (global,util,undefined) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = $kong() :
	typeof define === 'function' && define.amd ? define($kong) :
	(global.util = util());
} (
this, 
...
(function () {
	...
	function util (options) {var _=new $kongjs();_.init(options);return _}
	util.prototype = {
		version : version,
		constructor : $kongjs,
		options : null,
